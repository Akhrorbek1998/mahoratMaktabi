export const NAV_LINKS = ['Bosh sahifa', 'Biz haqimizda', 'Yo\'nalishlar', 'Ustozlar', 'Yangiliklar', 'Bog\'lanish uchun'];
...
export const STATS = [
  ...
  { value: '1',   suffix: '', label: "Prezidenttexnikumi", sublabel: "viloyatda yagona", icon: '🏛️' },
];
